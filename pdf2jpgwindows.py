...
logo = Label(text="Made by Pocono Eye associates", font=("Helvetica", 10), bg="#d1d1d1")
...
file_upload["font"] = font.Font(family="Helvetica", size=12)
send["font"] = font.Font(family="Helvetica", size=12)
